    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('complete_name', models.CharField(blank=True, max_length=255)),
                ('avatar', models.ImageField(blank=True, upload_to='users/static/img/')),
                ...
                ('telf_contact', models.CharField(blank=True, max_length=255)),
                ('location_contact', models.CharField(blank=True, max_length=255)),
